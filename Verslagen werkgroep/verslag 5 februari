...
2.	Usecases 
a.	Wat zijn de assen waarlangs we usecases kunnen bekijken(Remco Schaar)
...
b.	Discussie: Wat is een generieke grootste gemene deler voor het Nederlands profiel OAuth
...
3.	Scope profiel OAuth
a.	Wat zijn de assen waarlangs we scope kunnen afbakenen (Martin Borgman)
...
b.	Discussie: wat is binnen scope eerste versie, wat is binnen scope doorontwikkeling en wat is buiten scope
...
d.	Tijdspad plaatsen OAuth op Pas Toe of leg Uit lijst
